...
Assert-ContainsText $homeHtml "procurement and security teams" "buyer/workflow copy"
Assert-ContainsText $homeHtml "Restricted documents are blocked before Gemini" "homepage retrieval boundary"
Assert-ContainsText $homeHtml "A2A calls are verified" "homepage A2A proof"
Assert-ContainsText $homeHtml "hash-chain evidence proves the run" "homepage evidence proof"
