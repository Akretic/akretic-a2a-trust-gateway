...
Assert-ContainsText $homeHtml "procurement policy, blocks executive-only material before Gemini" "home form scenario"
...
Assert-ContainsText $runHtml "VendorNova review summary was generated from permitted procurement context." "review business result"
...
Assert-ContainsText $runHtml "Generated by Vertex Gemini from permitted source IDs only." "permitted summary subtext"
Assert-ContainsText $runHtml "What Akretic prevented" "prevention callout"
Assert-ContainsText $runHtml "The executive acquisition memo did not enter Gemini context." "prevented denied context"
...
Assert-ContainsText $runHtml "Vertex Gemini summarizes permitted sources only." "Gemini permitted context proof"
