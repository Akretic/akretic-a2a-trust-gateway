...
- P3 Cloud Run deployment hardening is the active lane.
- P6 is blocked non-blocking Google stretch until P3-P5 are stable.
- P7 is blocked post-challenge productization until P3-P5 are stable and the challenge path is complete.
...
| P3 | Cloud Run deployment | Active | Harden deploy scripts, service configuration, IAM notes, verification scripts, and rollback/runbook material for the existing Cloud Run shape. |
...
1. Do not pick P6 or P7 work if any P3-P5 acceptance gap is open.
...
5. Prefer narrow branches named after the active priority, for example `p3/cloudrun-hardening`.
