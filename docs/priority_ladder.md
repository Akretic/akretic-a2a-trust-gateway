...
- P4 Judge hardening is the active lane.
- P6 is blocked non-blocking Google stretch until P4-P5 are stable.
- P7 is blocked post-challenge productization until P4-P5 are stable and the challenge path is complete.
...
| P4 | Judge hardening | Active | Make the public judging path more resilient and self-explanatory while keeping admin/evidence surfaces role-checked and claims bounded. |
...
1. Do not pick P6 or P7 work if any P4-P5 acceptance gap is open.
...
5. Prefer narrow branches named after the active priority, for example `p4/judge-hardening`.
