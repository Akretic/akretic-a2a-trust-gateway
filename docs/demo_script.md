...
| 0:15–0:35 | Start VendorNova review | The Google ADK Workflow-wrapped root orchestrator uses Vertex AI Gemini and calls specialized agents over A2A Agent Card skill endpoints. |
